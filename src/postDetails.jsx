  ...
  return (
    <div className="postDetails">
      <div className="postAuthor">
        ...
        />
        <span className="authorUsername">{post.profiles?.username || 'Unknown'}</span>
      </div>

       {/* Display action buttons only if the current user is the post author */}
      {currentUser?.id === post.user_id && (
        <div className="actionButtons">
          <p>Posted: {timeAgo(post.created_at)}</p>
          <button className="editButton">
            <Link to={`/edit/${post.id}`} className="editButton">
